(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('ngx-country-picker', ['exports', '@angular/core', '@angular/common/http', '@angular/common', 'rxjs', 'rxjs/operators'], factory) :
    (global = global || self, factory(global['ngx-country-picker'] = {}, global.ng.core, global.ng.common.http, global.ng.common, global.rxjs, global.rxjs.operators));
    ...
    ***************************************************************************** */
    ...
    var COUNTRY_PICKER_CONFIG = new core.InjectionToken('countrypicker.config');
    ...
    var CountryPickerService = /** @class */ (function () {
        ...
        CountryPickerService.prototype.getCountries = function () {
            return this._data
                .pipe(operators.map(function (countries) {
        ...
        CountryPickerService.prototype._loadData = function () {
            return this._http.get(this._baseUrl + this._filename)
                .pipe(operators.catchError(CountryPickerService_1.handleError));
        };
        var CountryPickerService_1;
        CountryPickerService.ctorParameters = function () { return [
            { type: undefined, decorators: [{ type: core.Inject, args: [COUNTRY_PICKER_CONFIG,] }] },
            { type: http.HttpClient }
        ]; };
        CountryPickerService = CountryPickerService_1 = __decorate([
            core.Injectable(),
            __param(0, core.Inject(COUNTRY_PICKER_CONFIG))
    ...
    var CountryPickerModule = /** @class */ (function () {
            ...
            return {
                ...
                providers: [
                    { provide: COUNTRY_PICKER_CONFIG, useValue: providedConfig },
                    {
                        ...
                        deps: [COUNTRY_PICKER_CONFIG, http.HttpClient]
                    }
                ]
            };
        };
        ...
        CountryPickerModule.ctorParameters = function () { return [
            { type: CountryPickerModule, decorators: [{ type: core.Optional }, { type: core.SkipSelf }] }
        ]; };
    ...
    exports.COUNTRY_PICKER_CONFIG = COUNTRY_PICKER_CONFIG;
    exports.COUNTRY_PICKER_CONFIG_DEFAULT = COUNTRY_PICKER_CONFIG_DEFAULT;
    ...
    exports.ɵa = countryPickerServiceFactory;

    Object.defineProperty(exports, '__esModule', { value: true });

})));
//# sourceMappingURL=ngx-country-picker.umd.js.map
